...
public class VehicleDBHelper extends StarwarsOpenHelper
{


    private Dao<VehicleORM,Integer> mVehicleDao;
    ...
    public Dao<VehicleORM, Integer> getVehicleDao() throws SQLException
    {
        if (mVehicleDao == null) {
            mVehicleDao = getDao(VehicleORM.class);
        }
    ...
    {
        try{
            TableUtils.createTable(connectionSource,VehicleORM.class);
