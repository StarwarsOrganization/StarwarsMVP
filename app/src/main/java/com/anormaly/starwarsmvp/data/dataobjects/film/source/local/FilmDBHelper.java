...
public class FilmDBHelper extends StarwarsOpenHelper
{


    private Dao<FilmORM,Integer> mFilmDao;
    ...
    public Dao<FilmORM, Integer> getFilmDao() throws SQLException
    {
        if (mFilmDao == null) {
            mFilmDao = getDao(FilmORM.class);
        }
    ...
    {
        try{
            TableUtils.createTable(connectionSource,FilmORM.class);
