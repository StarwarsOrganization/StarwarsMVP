...
public class SpeciesDBHelper extends StarwarsOpenHelper
{


    private Dao<SpeciesORM,Integer> mSpeciesDao;
    ...
    public Dao<SpeciesORM, Integer> getSpeciesDao() throws SQLException
    {
        if (mSpeciesDao == null) {
            mSpeciesDao = getDao(SpeciesORM.class);
        }
    ...
    {
        try{
            TableUtils.createTable(connectionSource,SpeciesORM.class);
